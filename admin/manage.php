        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Store</h3>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard dataTables_wrapper dt-bootstrap">
                                        <div class="table-responsive" align="center">
                                            ...
                                            <table id="user_data" class="table table-bordered table-striped table-sm ">
                                                <thead>
                                                <tr>
                                                    <th>Name</th>
                                                    <th>Type</th>
                                                    <th>Brand</th>
                                                    <th style="font-size: 15px">Purchase_Price</th>
                                                    <th>Sale_Price</th>
                                                    <th>expireDate</th>
                                                    <th>AddDate</th>
                                                    <th>Quantity</th>
        ...
        <form method="post" id="user_form" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <br />
                    <input type="number" name="p_price" id="p_price" class="form-control" placeholder="purchase price" />
                    <br />
                    <input type="number" name="s_price" id="s_price" class="form-control" placeholder="sale price" />
                    <br />
    ...
    $(document).ready(function(){
        ...
        $(document).on('submit', '#user_form', function(event){
          ...
          /*  if(extension != '')
            ...
            if(barcode != '' && name != '' && p_price != ''&& s_price != '' && type !='' && brand !='' && expire !='' && quantity !='')
            {
                $.ajax({
                    url:"insert.php",
                    method:'POST',
