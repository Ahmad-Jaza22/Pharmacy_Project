        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div  class="col-md-8" align="right">
                    <input type="button" name="profitofdate" id="profitofdate" class="btn border-danger text-danger"  />
                    <input type="button" name="saleofdate" id="saleofdate" class="btn border-warning text-warning" />
...
<script>
    ...
    $(document).on('click', '#filter', function(){
        ...
        $.ajax({
            url:"report_sale_fetch_profit_sale.php",
            method:"POST",
            ...
            success:function(data)
            {
                ...
                // $('#').val(data.);
                $('#profitofdate').val("Profit : "+ data.profit);
                $('#saleofdate').val("Sale : " + data.with_discount);
