        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div  class="col-md-8" align="right">
                    <input type="button" name="purchaseofdate" id="purchaseofdate" class="btn border-warning text-warning" />
...
<script>
    ...
    $(document).on('click', '#filter', function(){
        ...
        $.ajax({
            url:"report_store_fetch_purchase.php",
            method:"POST",
            ...
            success:function(data)
            {
                ...
                // $('#').val(data.);
                $('#purchaseofdate').val("Purchase : "+ data.purchase);
